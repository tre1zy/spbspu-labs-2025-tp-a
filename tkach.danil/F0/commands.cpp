...
namespace tkach
{
  ...
  {
    using tree_of_dict = std::map< std::string, std::map< std::string, std::list< std::string > > >;
  ...
  void printAll(std::ostream& out, const std::map< std::string, std::map< std::string, std::list< std::string > > >& data)
  {
    if (data.empty())
    {
      throw std::logic_error("<EMPTY>");
