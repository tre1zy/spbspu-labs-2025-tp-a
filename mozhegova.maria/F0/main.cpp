...
int main(int argc, char * argv[])
{
  ...
  std::unordered_map< std::string, std::unordered_map< std::string, std::list< std::pair< size_t, size_t > > > > texts;
  ...
  // cmds["printtextin"] = std::bind(printText, std::ref(std::cin), std::ref(std::cout), std::cref(texts));
