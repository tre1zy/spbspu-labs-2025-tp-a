...
namespace shapkov
{
  ...
  void analyze_text(std::istream& in, std::ostream& out, FrequencyDictionary& dict);
  void word_info(std::istream& in, std::ostream& out, const FrequencyDictionary& dict);
  void anagrams(std::istream& in, std::ostream& out, const FrequencyDictionary& dict);
  void similar_frequency(std::istream& in, std::ostream& out, const FrequencyDictionary& dict);
  double entropyCount(const OneFreqDict& text);
  void entropy(std::istream& in, std::ostream& out, const FrequencyDictionary& dict);
  void total_words(std::istream& in, std::ostream& out, const FrequencyDictionary& dict);
  void palindromes(std::istream& in, std::ostream& out, const FrequencyDictionary& dict);
  void show_with_pattern(std::istream& in, std::ostream& out, const FrequencyDictionary& dict);
