...
std::istream& sherkunov::io_helpers::operator>>(std::istream& input, LexCharIO&& value)
{
    std::istream::sentry s(input);
    if (!s) {
        return input;
...
std::istream& sherkunov::io_helpers::operator>>(std::istream& input, LongLongIO&& value)
{
    std::istream::sentry s(input);
    if (!s) {
        return input;
...
std::ostream& sherkunov::io_helpers::operator<<(std::ostream& output, const LongLongIO& value)
{
...
std::istream& sherkunov::io_helpers::operator>>(std::istream& input, PairIO&& value)
{
    std::istream::sentry s(input);
    if (!s) {
        return input;
...
std::ostream& sherkunov::io_helpers::operator<<(std::ostream& output, const PairIO& value)
{
    std::ostream::sentry s(output);
    if (!s) {
        return output;
...
std::istream& sherkunov::io_helpers::operator>>(std::istream& input, StringIO&& value)
{
    std::istream::sentry s(input);
    if (!s) {
        return input;
...
std::ostream& sherkunov::io_helpers::operator<<(std::ostream& output, const StringIO& value)
{
    std::ostream::sentry s(output);
    if (!s) {
        return output;
...
std::istream& sherkunov::operator>>(std::istream& input, DataStruct& value)
{
    std::istream::sentry s(input);
    if (!s) {
        return input;
...
std::ostream& sherkunov::operator<<(std::ostream& output, const DataStruct& value)
{
    std::ostream::sentry s(output);
    if (!s) {
        return output;
...
bool sherkunov::operator<(const DataStruct& lhs, const DataStruct& rhs)
{
