...
namespace gavrilova {
  ...
  struct StudentPrinter {
    std::ostream& out;
    void operator()(const std::shared_ptr< const student::Student >& s) const
    {
  ...
  struct GradePrinter {
    ...
    {
      out << "  " << date::to_string(grade.first) << ": " << grade.second << '\n';
    }
  };

  CommandProcessor::CommandProcessor(StudentDatabase& db):
    db_(db),
    commandMap_()
  {
  ...
  void CommandProcessor::handleAddStudent()
  {
  ...
  void CommandProcessor::handleDeleteStudent()
  {
    StudentID id;
    std::cin >> id;
  ...
  void CommandProcessor::handleInfoStudent()
  {
    std::string token;
    std::cin >> token;
    StudentID id = 0;
  ...
  void CommandProcessor::handleListGroup()
  {
  ...
  void CommandProcessor::handleMoveGroup()
  {
    StudentID id;
    std::string newGroup;
    std::cin >> id >> newGroup;
  ...
  void CommandProcessor::handleAddGrade()
  {
    std::cout << "Команда addgrade еще не реализована.\n";
  }
  void CommandProcessor::handleChangeGrade()
  {
    std::cout << "Команда changegrade еще не реализована.\n";
  }

  void CommandProcessor::handleRemoveGrade()
  {
    std::cout << "Команда removegrade еще не реализована.\n";
  }

  void CommandProcessor::handleTopStudentsAll()
  {
    size_t n;
    std::cin >> n;
  ...
  void CommandProcessor::handleRiskStudentsAll()
  {
    double threshold;
    std::cin >> threshold;
  ...
  void CommandProcessor::handleTopStudentsGroup()
  {
    std::string groupName;
    size_t n;
    std::cin >> groupName >> n;
  ...
  void CommandProcessor::handleRiskStudentsGroup()
  {
    std::string groupName;
    double threshold;
  ...
  void CommandProcessor::handleExportForGrades()
  {
  ...
  void CommandProcessor::handleLoadGrades()
  {
    std::string groupName, filename;
    date::Date date;
  ...
  void CommandProcessor::handleGroupStats()
  {
    std::string groupName;
    DateRange period;
  ...
  void CommandProcessor::handleAvgMarkByDate()
  {
    date::Date date;
    std::cin >> date;
    if (std::cin.fail()) {
  ...
  void CommandProcessor::handleCreateGroup()
  {
    std::string groupName;
    std::cin >> groupName;
  ...
  void CommandProcessor::handleSave()
  {
    std::string filename;
    std::cin >> filename;
  ...
  void CommandProcessor::handleLoad()
  {
    std::string filename;
    std::cin >> filename;
