...
std::ostream &bob::operator<<(std::ostream &os, const ULLBinaryO &dest)
{
...
std::istream &bob::operator>>(std::istream &in, DelimiterIO &&data)
{
...
std::istream &bob::operator>>(std::istream &is, ULLLiteralIO &&dest)
{
...
std::istream &bob::operator>>(std::istream &is, ULLBinaryI &&data)
{
  std::istream::sentry sentry(is);
  if (!sentry)
  {
...
std::istream &bob::operator>>(std::istream &is, StringIO &&dest)
{
  std::istream::sentry sentry(is);
  if (!sentry)
  {
...
std::istream &bob::operator>>(std::istream &is, LabelIO &&dest)
{
  std::istream::sentry sentry(is);
  if (!sentry)
  {
...
std::istream &bob::operator>>(std::istream &is, DataStruct &data)
{
  std::istream::sentry sentry(is);
  if (!sentry)
  {
